...
EXTRACTION_PROMPT = (
    ...
    "2. distance: Cự ly (ví dụ 5K, 10K, Half Marathon, Full Marathon...). Nếu đây là giải "
    "chạy TRAIL (chạy địa hình/trail running - có chữ \"trail\" trên ảnh hoặc trong tên giải), "
    "ghi cự ly theo định dạng riêng cho trail như sau:\n"
    "   - Cự ly khoảng 100km: ghi \"TRAIL 100KM\"\n"
    "   - Cự ly từ 50km đến dưới 100km: ghi \"TRAIL 50+\"\n"
    "   - Cự ly trail khác (không thuộc 2 mốc trên): ghi \"TRAIL <số>KM\" theo đúng số km đọc "
    "được, ví dụ \"TRAIL 70KM\"\n"
...
CORE_TEAM = [
    {"name": "Phạm Đình Tuấn", "initials": "PT", "gradient": ("var(--orange)", "var(--teal-bright)"), "photo": "core-team/pham-dinh-tuan.jpg"},
